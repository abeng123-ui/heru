        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <strong class="card-title">Form Permintaan Alat Tulis Kantor</strong>
                </div>

                <div class="card-body">
                    <form id="FormIni" method="POST" enctype="multipart/form-data" action="{{url('permintaan/jurusan/store')}}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <input id="sisa_brg" name="sisa" type="number" value="0" readonly class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="form-control-label">Satuan</label>
                            <input id="satuan_brg" name="satuan" type="text" value="" readonly class="form-control">
                        </div>

                        <div class="form-group">
                            <label class=" form-control-label">Jumlah</label>
                            <input id="jumlah_brg" value="" name="jumlah" type="number" onchange="checkJumlah(this.value)" class="form-control">
                        </div>
