...
@section('content')
<?php
$acl = \App\Models\Role::where('id', \Auth::user()->role_id)->where('route_access_list', 'LIKE', '%'.'kategori.index'.'%')->count();
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header card-header-primary">
          ...
          <a class="btn btn-info" href="{{ url('kategori/create') }}">Tambah Kategori</a>
          <br>
              ...
              <?php $x=1; ?>
                  @foreach($data as $row)
                      <tr>
                          ...
                          <th align="center">
                            <a class="btn btn-primary" href="{{ url('kategori/edit') }}/{{ $row->id }}">Ubah</a>
                              <a onclick="return hapus()" href="{{url('kategori/delete')}}/{{$row->id}}" type="submit" class="btn btn-danger">Hapus</a>
                          </th>
