    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="FormIni" method="POST" enctype="multipart/form-data" action="{{url('permintaan/store')}}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <input id="sisa_brg" name="sisa" type="text" value="0" readonly class="form-control">
                        </div>
